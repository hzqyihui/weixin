...
class Jibian_weixin {
	...
	public function get_access() {
		$access_log_file_path = FCPATH."application/libraries/access_token.log";
		$result = FALSE;
		try {
...
//		}
		...
		$url = "https://api.weixin.qq.com/cgi-bin/material/batchget_material?access_token='k3uvUN9fiRzkbX6ZFFFOmJ6Md3PW2c1L_fciRJTqVaeIoSNG7j3o8Jc6AxUXfKGwy9aWdxBMfBundfk756rPno7CGrdWa6fqc2tLXdkTQFu6ksBcT6mZ2jrK2ggnGNyqRSJdAGAMNE'";
	...
	public function curl_download($filepath, $url) {
		...
		try {
			...
			file_put_contents(FCPATH."exception".date('Y-m-d').".log", date('Y-m-d H:i:s') . "日志信息：保存已下载的文件时出现异常，异常信息：{$e}\n", FILE_APPEND);
			return FALSE;
		}
